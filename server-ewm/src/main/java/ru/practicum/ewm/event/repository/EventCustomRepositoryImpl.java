...
public class EventCustomRepositoryImpl implements EventCustomRepository {
    ...
    public List<Event> getEventsByAdmin(List<Long> users, List<State> states, List<Long> categories,
    ...
    public List<Event> getEventsByPublic(String text, List<Long> categories, Boolean paid, LocalDateTime rangeStart,
        ...
        criteria = builder.and(criteria, root.get("state").in(State.PUBLISHED));
